 ...
 */
public class ChartView1 extends View implements InterfaceTouch {
    ...
    public ChartView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChartView1(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        Log.i(TAG, "height:" + height);
        canvas.drawText("你好你好", dpToPx(100), height + dpToPx(20), xyTextPaint);
    ...
    private void drawBrokenLine(Canvas canvas) {
        ...
        for (int i = 1; i < xValue.size(); i++) {
            x = xInit + interval * i;
            Log.i(TAG, "drawBrokenLine: 绘制折线 xInit：" + xInit + "interval:" + interval);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (interval * xValue.size() > width - xOri) {//当期的宽度不足以呈现全部数据
                    ...
                    if (mInterfaceTouch != null) {
                        Log.i(TAG, "onTouchEvent: ACTION_MOVE startX:" + startX + "minXInit:" + minXInit);
